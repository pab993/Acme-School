...
public class UserAccount extends DomainEntity implements UserDetails {
	...
	public boolean isAccountNonLocked() {
		Boolean res = true;
		if(this.actor instanceof Teacher){
			Teacher teacher = (Teacher)actor;
			res = res&&!teacher.getIsArchive()&&!teacher.getSchool().getIsArchive()&&!teacher.getSchool().getIsCancel();
		}
