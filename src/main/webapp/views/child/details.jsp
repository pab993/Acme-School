	...
	<security:authorize access="hasRole('PARENT')">
		<jstl:choose>
			<jstl:when test="${principal.id==child.parent.userAccount.id}">
				...
				<a href="school/classes/parent/${child.id}/list.do" type="button" class="btn btn-warning">
					<spring:message code="child.class" />
				</a>
				<a href="child/parent/observation/${child.id}/list.do" type="button" class="btn btn-warning">
					<spring:message code="child.observaciones" />
				</a>
				<a href="child/parent/event/${child.id}/list.do" type="button" class="btn btn-warning">
